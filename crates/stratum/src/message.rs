...
"00000002", "1c2ac4af", "504e86b9", false], "id": null, "method": "mining.notify"}"#;
    ...
    fn subscribe() {
        case(
            r#"{"id":1,"method":"mining.subscribe","params":["blackpool/0.5.2"]}"#,
            Message::Request {
                id: Id::Number(1),
                method: "mining.subscribe".into(),
                params: serde_json::to_value(Subscribe {
                    user_agent: "blackpool/0.5.2".into(),
                    enonce1: None,
                })
                .unwrap(),
            },
        ...
        case(
            r#"{"id":2,"method":"mining.subscribe","params":["blackpool/0.1","abcd"]}"#,
            Message::Request {
                id: Id::Number(2),
                method: "mining.subscribe".into(),
                params: serde_json::to_value(Subscribe {
                    user_agent: "blackpool/0.1".into(),
