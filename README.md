<h1 align=center><code>blackpool</code></h1>

<div align=center>
  <a href=https://crates.io/crates/blackpool>
    <img src=https://img.shields.io/crates/v/blackpool.svg alt="crates.io version">
  </a>
  <a href=https://github.com/classifiedcc/blackpool/actions/workflows/ci.yaml>
    <img src=https://github.com/classifiedcc/blackpool/actions/workflows/ci.yaml/badge.svg alt="build status">
  </a>
  <a href=https://github.com/classifiedcc/blackpool/releases>
    <img src=https://img.shields.io/github/downloads/classifiedcc/blackpool/total.svg alt=downloads>
  </a>
</div>
<br>

`blackpool` is a command-line tool for miners and pools. It is experimental
...
runs on `blackpool.com:42069`. For instructions on how to connect, please visit
[blackpool.com](https://blackpool.com?help).
...
`blackpool` is more than just glue code around ckpool though. It implements a Rust
...
list of available commands just follow the instructions below and do `blackpool
help`.
...
Clone the `blackpool` repo:

```
git clone https://github.com/classifiedcc/blackpool.git
cd blackpool
```

To build a specific version of `blackpool`, first checkout that version:

```
git checkout <VERSION>
```

And finally to actually build `blackpool`:

```
cargo build --release
```

Once built, the `blackpool` binary can be found at `./target/release/blackpool`.

You can also install `blackpool` directly into your path by doing:
